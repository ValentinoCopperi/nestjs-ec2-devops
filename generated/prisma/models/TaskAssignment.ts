...
export interface TaskAssignmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const taskAssignmentWithAssignedAtOnly = await prisma.taskAssignment.findMany({ select: { assignedAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TaskAssignments and only return the `assignedAt`
   * const taskAssignmentWithAssignedAtOnly = await prisma.taskAssignment.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more TaskAssignments and only return the `assignedAt`
   * const taskAssignmentWithAssignedAtOnly = await prisma.taskAssignment.updateManyAndReturn({
   *   select: { assignedAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
